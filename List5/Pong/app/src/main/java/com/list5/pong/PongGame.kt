...
import com.list5.pong.Shape
import com.list5.pong.ShapeType
import com.list5.pong.Vector2D

class PongGame(context: Context, attributeSet: AttributeSet): SurfaceView(context, attributeSet), SurfaceHolder.Callback
{
    val shapes: MutableList<Shape> = mutableListOf()
    private lateinit var thread: PongGameThread
    var onUpdate: () -> Unit = {}
    ...
    {
        thread = PongGameThread(holder, this)
        thread.start()
        onSurfaceCreated()
